...
def extract_text_from_pdf(file):
    try:
        ...
        ocr_text = ""
        for img in images:
            ocr_text += pytesseract.image_to_string(img.convert("RGB"), lang="eng")
...
def scrape_jobs():
    ...
    salary_min = request.json.get("salary_min", "").strip()
    ...
    params = {
        "app_id": os.getenv("ADZUNA_APP_ID", "30c6c5c3"),
        "app_key": os.getenv("ADZUNA_APP_KEY", "5f7d3f9f997c0720ea62dd93c8b2200d"),
        "results_per_page": 6,
        "what": job_role,
